...
> A dynamic mouse cursor that morphs and expands over interactive UI elements.

---

## 📌 Project Overview
**Custom Cursor Hover Effects** is a frontend web development project designed to showcase core web concepts, DOM manipulation, and responsive UI design. Built using vanilla web technologies without external frameworks.
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/mohsinshah12309/custom-cursor-on-hover.git
   ```
